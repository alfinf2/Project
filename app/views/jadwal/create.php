...
<div class="container">
    <div class="row justify-content-lg-center mt-5">
        <div class="col-lg-5 col-sm-auto">
            <div class="card">
                <div class="card-body">
                    <h5 class="alert-primary text-center my-4 mt-3">Tambah Jadwal Pelajaran</h5>
                    <form id="createJadwalForm" action="<?= BASE_URL; ?>/jadwal/store" method="post">
            ...
            .then(data => {
                if (data.status) {
                    Swal.fire({
                        ...
                        confirmButtonText: 'Tambah Data Lain',
                        cancelButtonText: 'Kembali ke Daftar'
                    }).then((result) => {
                        if (result.isConfirmed && data.status) {
                            window.location.href = '<?= BASE_URL ?>/jadwal/create';
                        } else {
                    ...
                    Swal.fire({
                        title: 'Gagal!',
                        text: data.message || 'Gagal menambahkan jadwal',
                        icon: 'error',
