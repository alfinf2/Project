<div class="container">
    <div class="row justify-content-lg-center mt-5">
        <div class="col-lg-5 col-sm-auto">
            <div class="card">
                <div class="card-body">
                    <h5 class="alert-primary text-center my-4 mt-3">Edit Mapel</h5>
                    <form id="createSiswaForm" action="<?= BASE_URL; ?>/mapel/update/<?= $data['mapel']['id_mapel']?>" method="post">

                        <div class="form-group">
                            <input type="text" class="form-control" id="mapel" name="inp_mapel" value="<?= $data['mapel']['nama_mapel']?>"
